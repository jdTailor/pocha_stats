...
# --- ESTILO GLOBAL PARA TABLAS (Títulos centrados y sin negrita) ---
st.markdown("""
    <style>
        .stTable {
        ...
        /* Cabeceras: Sin negrita y CENTRADAS por defecto */
        .stTable th {
        ...
        /* Excepción: Primera columna (Nombres/Fechas) alineada a la IZQUIERDA */
...
if not st.session_state.historico.empty:
    ...
    st.write("Leyenda: **Posición (Pedidas / Hechas)**")
